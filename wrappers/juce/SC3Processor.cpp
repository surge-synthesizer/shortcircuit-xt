...
//==============================================================================
const juce::String SC3AudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool SC3AudioProcessor::acceptsMidi() const
{
    return true;
}

bool SC3AudioProcessor::producesMidi() const
{
    return false;
}

bool SC3AudioProcessor::isMidiEffect() const
{
    return false;
}

double SC3AudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}
...
int SC3AudioProcessor::getCurrentProgram()
{
    return 0;
}
...
const juce::String SC3AudioProcessor::getProgramName (int index)
{
    return {};
}
...
void SC3AudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
