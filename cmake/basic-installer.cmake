...
if (WIN32)
    if ("${CMAKE_GENERATOR_PLATFORM}" STREQUAL "arm64ec")
        set(SCXT_ZIP shortcircuit-xt-${CMAKE_SYSTEM_NAME}-${CMAKE_GENERATOR_PLATFORM}-${SCXT_DATE}-${VERSION_CHUNK}.zip)
    else()
        set(SCXT_ZIP shortcircuit-xt-${CMAKE_SYSTEM_NAME}-${BITS}bit-${SCXT_DATE}-${VERSION_CHUNK}.zip)
    endif()
else ()
    set(SCXT_ZIP shortcircuit-xt-${CMAKE_SYSTEM_NAME}${SCXT_EXTRA_INSTALLER_NAME}-${SCXT_DATE}-${VERSION_CHUNK}.zip)
endif ()
