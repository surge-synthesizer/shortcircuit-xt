...
SCXTProcessor::SCXTProcessor()
    : juce::AudioProcessor(juce::AudioProcessor::BusesProperties()
                               ...
                               .withOutput("Out 17", juce::AudioChannelSet::stereo(), false)
                               .withOutput("Out 18", juce::AudioChannelSet::stereo(), false)
                               .withOutput("Out 19", juce::AudioChannelSet::stereo(), false)
                               .withOutput("Out 20", juce::AudioChannelSet::stereo(), false)
                               .withOutput("Out 21", juce::AudioChannelSet::stereo(), false)),
      blockPos(0)
{
