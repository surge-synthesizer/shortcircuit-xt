...
#ifndef SCXT_SRC_SCXT_CORE_MESSAGING_CLIENT_CLIENT_SERIAL_H
#define SCXT_SRC_SCXT_CORE_MESSAGING_CLIENT_CLIENT_SERIAL_H
...
enum ClientToSerializationMessagesIds
{
    ...
    c2s_set_pitchbend_tuning_awareness,
    c2s_set_omni_flavor,
