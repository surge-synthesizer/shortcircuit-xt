...
enum struct EditSubtree : int32_t
{
    ...
    coalesce_batch, // not a subtree: brackets a batch of mutations (e.g. a
                        ...
                        messaging::MessageController &cont)
{
    ...
    case EditSubtree::part_stream:
        ...
        break;
    case EditSubtree::coalesce_batch:
        if (B == undo::UndoGesture::Begin)
            engine.undoManager.beginCoalescing();
        break;
                      ...
                      messaging::MessageController &cont)
{
    ...
    engine.undoManager.endCoalescing();
