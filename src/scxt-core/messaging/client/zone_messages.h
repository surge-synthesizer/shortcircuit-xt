...
#ifndef SCXT_SRC_SCXT_CORE_MESSAGING_CLIENT_ZONE_MESSAGES_H
#define SCXT_SRC_SCXT_CORE_MESSAGING_CLIENT_ZONE_MESSAGES_H
...
CLIENT_TO_SERIAL_CONSTRAINED(UpdateZoneVariantsInt16TValue, c2s_update_zone_variants_int16_t,
                             ...
                             detail::updateZoneMemberValue<undo::ZoneVariantsSpec>(
                                 &engine::Zone::variantData, payload, engine, cont));
...
CLIENT_TO_SERIAL_CONSTRAINED(UpdateZoneOutputFloatValue, c2s_update_zone_output_float_value,
                             ...
                             detail::updateZoneMemberValue<undo::ZoneOutputInfoSpec>(
                                 &engine::Zone::outputInfo, payload, engine, cont));
