...
#ifndef SCXT_SRC_SCXT_CORE_MESSAGING_CLIENT_CLIENT_MESSAGES_H
#define SCXT_SRC_SCXT_CORE_MESSAGING_CLIENT_CLIENT_MESSAGES_H
...
#include "group_or_zone_messages.h"
