...
/*	md_AEG_shape1,
	...
	md_num_destinations=md_num_zone_destinations,  //std::max(md_num_part_destinations,md_num_zone_destinations)
};
...
public:
	...
	void add_destination(unsigned char RIFFID, int id, const char* name, int control_type, const char* dispname = 0);
