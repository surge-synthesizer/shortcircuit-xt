...
public:	
	...
	double calc_omega_from_Hz(double Hz){ return (2*3.14159265358979323846) * Hz *samplerate_inv; }
	static double calc_omega(double scfreq){ return (2*3.14159265358979323846) * 440*note_to_pitch(12*scfreq)*samplerate_inv; }
