...
static const interactiondata ip_data[] = {
    ...
    },
    {
        ip_nc_src,
        ipvt_int,
        (int)offsetof(sample_zone, trigger_conditions[0].source),
        num_zone_trigger_conditions,
        (int)sizeof(trigger_condition_entry),
        "zone trigger_conditions src",
    },
    {
        ip_nc_low,
        ipvt_int,
        (int)offsetof(sample_zone, trigger_conditions[0].low),
        num_zone_trigger_conditions,
        (int)sizeof(trigger_condition_entry),
        "zone trigger_conditions low",
        ip_range_and_units::fromDatamodeString("i,0,127,0,"),
    },
    {
        ip_nc_high,
        ipvt_int,
        (int)offsetof(sample_zone, trigger_conditions[0].high),
        num_zone_trigger_conditions,
        (int)sizeof(trigger_condition_entry),
        "zone trigger_conditions high",
        ip_range_and_units::fromDatamodeString("i,0,127,0,"),
    },
    {
        ip_ignore_part_polymode,
    ...
    },
    {
        ip_part_nc_src,
        ipvt_int,
        (int)offsetof(sample_part, trigger_conditions[0].source),
        num_part_trigger_conditions,
        (int)sizeof(trigger_condition_entry),
        "part trigger_conditions src",
    },
    {
        ip_part_nc_low,
        ipvt_int,
        (int)offsetof(sample_part, trigger_conditions[0].low),
        num_part_trigger_conditions,
        (int)sizeof(trigger_condition_entry),
        "part trigger_conditions low",
        ip_range_and_units::fromDatamodeString("i,0,128,0,"),
    },
    {
        ip_part_nc_high,
        ipvt_int,
        (int)offsetof(sample_part, trigger_conditions[0].high),
        num_part_trigger_conditions,
        (int)sizeof(trigger_condition_entry),
        "part trigger_conditions high",
        ip_range_and_units::fromDatamodeString("i,0,128,0,"),
    },
    {
        ip_multi_filter_object,
