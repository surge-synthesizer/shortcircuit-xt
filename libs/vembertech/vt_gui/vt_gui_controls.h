...
// comma-seperated labels (samma params som button annars)
 ...
 // display/editor parameter display that mostly work as a display for other parameters (by intercepting their events)
 // make sure an edited value is sent to all controls associated with that param id/subid
 // removes the need to have displays on sliders etc..
